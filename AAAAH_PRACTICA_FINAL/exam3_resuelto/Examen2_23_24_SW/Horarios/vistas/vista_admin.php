    ...
    if(isset($_POST["profesor"]))
    {
                ...
                for($dia=1;$dia<=5;$dia++)
                {
                    if(isset($horario[$dia][$hora]))
                    {
                        ...
                        echo "<input type='hidden' name='profesor' value='".$_POST["profesor"]."'>
                            <input type='hidden' name='dia' value='".$dia."'><input type='hidden' name='hora' value='".$hora."'>";
                    ...
                    else
                    {
                        echo "<td>";
                        echo "<form action='index.php' method='post'>";
                        echo "<input type='hidden' name='profesor' value='".$_POST["profesor"]."'><input type='hidden' name='dia' value='".$dia."'>
        ...
        if(isset($_POST["dia"]))
        {
            ...
            foreach($obj3->horario as $tupla)
            {
                ...
                echo "<form action='index.php' method='post'>";
                echo "<input type='hidden' name='profesor' value='".$_POST["profesor"]."'>
                    <input type='hidden' name='dia' value='".$_POST["dia"]."'><input type='hidden' name='hora' value='".$_POST["hora"]."'>";
