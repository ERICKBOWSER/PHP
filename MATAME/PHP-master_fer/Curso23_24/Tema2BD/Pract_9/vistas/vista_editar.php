...
if (mysqli_num_rows($resultado) > 0) {
    ...
    if (isset($_POST["btnEditar"])) {
        ...
        $caratula = $datos_pelicula["caratula"];
    } else {
        //recojo del $_POST
        $titulo = $_POST["titulo"];
        ...
        $caratula = $_POST["caratula_bd"]; //Lo meto en un hidden porque en el $_POST no está
    }
} else {
    $error_existencia = "<p>La pelicula seleccionada ya no se encuentra en la BD</p>";
}

if (isset($error_existencia)) {
    echo "<h2>Editando la pelicula con id " . $idPeliculas . "</h2>";
    ...
    //Pongo el formulario
?>
    <h2>Editando la pelicula con id <?php echo $idPeliculas; ?></h2>
