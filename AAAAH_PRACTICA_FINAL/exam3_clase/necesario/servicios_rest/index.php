...
$app->get('/logueado', function($request){
    ...
    if(isset($_SESSION["usuario"])){
        echo json_encode(logueado($_SESSION["usuario"], $_SESSION["clave"])); // COGEMOS LOS DATOS DE LA SESIÓN PORQUE YA SE HA LOGUEADO
    }else{
        session_destroy();
...
// SI UN USUARIO NO ES ADMIN NO PUEDE USAR ESTE METODO
