...
{
    session_destroy();
    die(error_page("Examen4 DWESE Curso 23-24","<h1>Notas de los alumnos</h1><p>Sin respuesta oportuna de la API desde vista_normal</p>"));  
}
if(isset($json["error"]))
{
...
<body>
    ...
    <h2>Notas del Alumno <?php echo $datos_usuario_log["nombre"];?>
    <?php
    echo "<table>";
        echo "<tr>";
