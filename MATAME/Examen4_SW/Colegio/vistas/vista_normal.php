...
if(!$json){
    session_destroy();
    die(error_page("Examen4", "<h1>Notas de los alumnos</h1><p>Sin respuesta oportuna de la API desde VISTA_NORMAL</p>"));
}
...
if(isset($json["no_auth"])){
    session_unset();
    $_SESSION["seguridad"]="Usted ha dejado de tener acceso a la API. Por favor vuelva a loguearse desde VISTA_NORMAL.";
...
<head>
    ...
    <title>Examen4 VISTA NORMAL</title>
    <style>
...
<body>
    ...
    <?php
        ...
        echo "<table>";
        echo "<tr>th>Asignaturas</th><th>Nota</th></tr>";
