const DIR_SERV="http://localhost/Proyectos/Curso23_24/Teor_Servicios_Web/primera_api";
...
{
    $.ajax({
        url:"http://localhost/Proyectos/Curso23_24/Servicios_Webs/Ejercicio1/servicios_rest/productos",
        dataType:"json",
        type:"GET"
    })
    .done(function(data){
