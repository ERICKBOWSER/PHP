...
{
    $datos_linea=mi_explode("\t",$linea); // Le pasamos una linea del fichero (devuelve array)
    if(isset($_POST["btnVerHorario"])&& $_POST["profesor"]==$datos_linea[0]) // $datos_linea[0] es para que siempre se muestre los datos inciales de apellidos
     {
...
<form action="ejercicio4.php" method="post">
    <p>
        ...
        <select name="profesor" id="profesor"> <!-- Los options estan en el código de arriba -->
        <?php
            echo $options;
        ?>
        </select>
