...
if(isset($_POST["btnEnviar"])){
    ...
    if(!$error_form){
        ...
        if(!$json){
            session_destroy();
            die(error_page("Practica 3", "<h1>Practica 3</h1><p>Sin respuesta oportuna de la API desde VISTA_HOME</p>"));
        }
        ...
        <p>
            ...
            if(isset($_POST["btnEntrar"]) && $error_usuario){
                if($_POST["usuario"]==""){
                    ...
                    echo "<span class='error'>Usuario y/p Contraseña no validos</span>";
                }
            }
            ?>
        </p>
