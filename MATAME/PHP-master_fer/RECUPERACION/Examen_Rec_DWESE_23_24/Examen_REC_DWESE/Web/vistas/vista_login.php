...
if (isset($_POST["btnEntrar"])) {
    ...
    if (!$error_form) {
        ...
        if (!$json) {
            session_destroy();
            die(error_page("Examen_Rec_23_24", "<h1>Examen_Rec_23_24</h1><p>Sin respuesta oportuna de la API</p>"));
        }
        if (isset($json["error_bd"])) {
            session_destroy();
            die(error_page("Examen_Rec_23_24", "<h1>Examen_Rec_23_24</h1><p>" . $json["error_bd"] . "</p>"));
        }
